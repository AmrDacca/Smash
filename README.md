...
This project was implemented during the course Operating Systems in of which we were asked to implement a working like shell with changes to some functionality of some commands of the shell (less options to some commands) and keeping other commands to work similar as the normal shell
